...
function StarsPage() {
  useSEO({
    ...
    description: "Roles, skills, agents, and memories you've starred on StrawHub.",
    url: "/stars",
    noindex: true,
  });
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-lg border border-gray-800 p-5 md:p-8 text-center">
          <p className="text-gray-400 mb-4">
            Sign in with GitHub to see roles, skills, agents, and memories you've starred.
          </p>
          <button
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-gray-400">
        Roles, skills, agents, and memories you've starred.
      </p>
      <StarredList />
    </div>
  );
...
function StarredList() {
  ...
  if (!hasSkills && !hasRoles && !hasAgents && !hasMemories) {
    return (
      <div className="rounded-lg border border-gray-800 p-6 md:p-12 text-center">
        ...
        <p className="text-sm text-gray-500 mb-6">
          Star roles, skills, agents, and memories to keep track of them here.
        </p>
